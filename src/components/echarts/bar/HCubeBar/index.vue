...
import { HCubeTop, HCubeBottom, HCubeRight } from './cube'
...
echarts.graphic.registerShape('HCubeTop', HCubeTop)
echarts.graphic.registerShape('HCubeBottom', HCubeBottom)
echarts.graphic.registerShape('HCubeRight', HCubeRight)
    ...
    },
    {
      ...
      renderItem: function (params, api) {
        return renderItem(
          ...
          props.single === 1 ? 0 : 1,
          {
            left: ['#bfae22', 'rgba(191, 174, 34,0.01)'],
            right: ['#bfae22', 'rgba(191, 174, 34,0.01)'],
            top: '#BFCDFF'
          },
          // {
