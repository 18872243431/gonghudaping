<template>
  <div class="risk-warning">
      ...
      <div class="card-content">
        ...
        <div class="pyramid-container">
          <div
            ...
            :key="i"
          >
            <p style="color: #06fbff; font-size: var(--font-label)">
              {{ d.name }}
            </p>
    ...
    <div class="arrow-right" style="left: 356px"></div>
    <div class="risk-warning-card">
    ...
    <div class="arrow-right" style="left: 735px"></div>
    <div class="risk-warning-card">
      ...
      <div class="card-content">
        ...
        <div class="card-bottom" style="height: 534px">
          <chart-box title="通报行业排名">
            <template v-slot:chart>
              ...
              >
                <template #label="{ row }">
                  <div class="table-label" :title="row.label">
                    {{ row.label }}
                  </div>
                </template>
              </act-table>
    ...
    <div class="arrow-right" style="left: 1109px"></div>
    <div class="risk-warning-card">
      ...
      <div class="card-content">
        ...
        <div class="card-bottom" style="height: 580px">
          <chart-box title="各省通报处置情况排名">
            <template v-slot:chart>
              <CubeBarLine
                style="margin-left: -20px; margin-right: -20px; width: 115%"
                ...
                :cubeOption="{ width: 8, height: 4, space: 2 }"
                :bottom="50"
                :option="{
                  yAxis: [{}, {}],
                  tooltip: {
                    formatter: (params) => {
                      ...
                      <p style=font-size:18px;color:#fff;>通报：${value1}</p>
                      <p style=font-size:18px;color:#fff;>处置：${value2}</p>
                      <p style=font-size:18px;color:#fff;>处置率：${value3}%</p>
                      `;
                    },
                  },
                }"
    ...
    <div class="arrow-right" style="left: 1484px"></div>
    <div class="risk-warning-card">
      ...
      <div class="card-content">
        ...
        <div class="chart-container">
          <cube-bar
            :data="cubeData"
            :single="0"
            :cubeOption="{ width: 24, height: 6, space: 12 }"
            :option="{
              legend: { show: false },
              yAxis: { show: false },
            }"
