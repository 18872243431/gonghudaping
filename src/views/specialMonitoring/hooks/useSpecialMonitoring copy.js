...
export function useLeft() {
  ...
  async function getEventListData() {
    // 使用模拟数据替代API调用
    eventList.value = mockData.eventList;
  }

  async function getSpecialDetailData() {
    // 使用模拟数据替代API调用
    const data = mockData.specialDetail;
    const obj = {
      ...data,
  ...
  async function getRealTimeAttackDynamicsData() {
    // 使用模拟数据替代API调用
    noticeData.value = mockData.realTimeAttackDynamics;
  }
...
export function useCenter() {
  ...
  async function getNumberCardData() {
    // 使用模拟数据替代API调用
    const data = mockData.numberCard;
  ...
  async function getRiskEnterpriseData() {
    // 使用模拟数据替代API调用
    companyList.value = mockData.riskEnterprise;
  }
...
const rankBarData = ref([
  ...
  async function getEventTypeDistributionData() {
    // 使用模拟数据替代API调用
    const data = mockData.eventTypeDistribution;
  ...
  async function getAttackCountryRankingData() {
    // 使用模拟数据替代API调用
    tableData.value = mockData.attackCountryRanking;
  }
...
export function useRight2() {
  ...
  async function getAttackIPBehaviorAnalysisData() {
    // 使用模拟数据替代API调用
    const data = mockData.attackIPBehaviorAnalysis;
  ...
  async function getAttackTrendData() {
    // 使用模拟数据替代API调用
    const data = mockData.attackTrend;
