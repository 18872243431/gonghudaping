          ...
          <el-card class="box-card">
            ...
            <div class="view">
              <div class="list">
                ...
                >
                  <div class="header">
                    <span class="title" :title="item.eventName">{{
                      item.eventName
                    }}</span>
                    <img
                      class="status-icon"
...
async function getGuaranteeListData() {
...
const events = ref([
  // { eventName: "123", eventStatus: "1" },
]);
async function getGuaranteeList2Data() {
